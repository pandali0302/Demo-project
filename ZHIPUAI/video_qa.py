...
# Example usage:
video_url = [
    "https://www.bilibili.com/video/BV1jH4y1w7tX/?spm_id_from=333.999.0.0&vd_source=f187bdb853f3690201169c42c99729e6"
]
query = "请用中文回答冷冻需要几个小时？"
...
# ----------------------------------------------------------------
# use YoutubeLoader from LangChain to load the transcript of a Youtube video
# ----------------------------------------------------------------
